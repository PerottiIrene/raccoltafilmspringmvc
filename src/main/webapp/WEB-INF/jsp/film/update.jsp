			...
			<main class="flex-shrink-0">
			  ...
			  <div class='card'>
				    ...
				    <div class='card-body'>
							...
							<form:form modelAttribute="update_film_attr" method="post" action="${pageContext.request.contextPath}/film/executeUpdate" class="row g-3" novalidate="novalidate">
							...
							<input type="hidden" name="id" value="${update_film_attr.id }" >
								...
								<div class="col-md-6">
									...
									<spring:bind path="titolo">
										<input type="text" name="titolo" id="titolo" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire il nome" value="${update_film_attr.titolo }" required>
									</spring:bind>
								...
								<div class="col-md-6">
									...
									<spring:bind path="genere">
										<input type="text" name="genere" id="genere" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire il cognome" value="${update_film_attr.genere }" required>
									</spring:bind>
								...
								<div class="col-md-6">
									...
									<input type="number" class="form-control" name="minutiDurata" id="minutiDurata" placeholder="Inserire la durata" value="${update_film_attr.minutiDurata }"required>
									</spring:bind>
